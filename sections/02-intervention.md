...
| Víctimas observadas de abuso sexual intrafamiliar (nacional) | **1.819** | <span class="badge badge-derivado" title="3.219 × 56,5% UNICEF/Línea 137">◇ Derivado</span> |
| Víctimas CABA-equivalentes (prorrateo 35,5%) | **646** | <span class="badge badge-derivado" title="1.819 × 35,5% participates CABA (informe L137 2017-oct 2023)">◇ Derivado</span> |
| **Ratio CABA↔Nacional (conservador)** | **1,94 : 1** | |
| **Ratio CABA↔CABA (prorrateado)** | **5,46 : 1** | |

**Lectura:** por cada víctima observada de abuso sexual intrafamiliar **en CABA**, hay aproximadamente **5,46 NNyA** en causas con al menos una decisión judicial de ruptura familiar — sin que esa decisión corresponda, en todos los casos, a victimización probada. El ratio 1,94:1 (nacional) se conserva como cota conservadora; al ajustar el denominador a la misma jurisdicción del numerador, la magnitud se amplia consistentemente con lo predicho en §6 (cfr. nota sobre equivalencia jurisdiccional). El cociente debe leerse como un indicador de orden de magnitud, no como una equivalencia funcional entre ambas poblaciones.[^cron]
