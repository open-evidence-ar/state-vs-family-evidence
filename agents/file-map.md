...
llms-full.txt                       Generated by _plugins/llms_full_generator.rb on every
                                    Jekyll build. Concatenates all section Markdown into one
                                    file for LLM copy-paste. Not tracked in git.
```
...
```
_plugins/llms_full_generator.rb     Jekyll hook: generates llms-full.txt on every build
